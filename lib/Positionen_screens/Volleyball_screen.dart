...
import 'package:malie/Data/volleyball_data.dart';
...
class PositionVolleyball extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: AppBarPositionen('volleyball'),
      ),
      body: Column(
        children: [
          Container(
          ...
          Expanded(
            child: Container(
              ...
              child: GridView(
                ...
                children: VOLLEYBALL_POSITIONEN
                    .map(
